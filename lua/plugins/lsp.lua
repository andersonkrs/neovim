    ...
    config = function()
      ...
      lsp.on_attach(function(client, bufnr)
        ...
        vim.keymap.set('n', '<Leader>ca', function() vim.lsp.buf.code_action() end,
          { desc = "[C]ode [Action]", buffer = bufnr, remap = false })
        vim.keymap.set('n', '<Leader>xs', function() vim.diagnostic.open_float() end,
          { desc = "Show Diagnostic", buffer = bufnr, remap = false })
      end)
